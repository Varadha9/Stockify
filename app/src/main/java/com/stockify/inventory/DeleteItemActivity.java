...
public class DeleteItemActivity extends AppCompatActivity {
    ...
    private void deleteItem(InventoryItem item) {
        AppExecutor.get().execute(() -> {
            ...
            deleteImageFile(item.getImagePath());
        ...
        try {
            ...
            if ("file".equals(uri.getScheme())) {
                ...
                if (file.exists() && file.getAbsolutePath()
                    ...
                    if (!file.delete()) {
                        android.util.Log.w("DeleteItemActivity", "Failed to delete image: " + imagePath);
                    }
                }
            }
    ...
    class DeleteAdapter extends RecyclerView.Adapter<DeleteAdapter.VH> {
        ...
        void setItems(List<InventoryItem> newItems) {
            List<InventoryItem> oldList = new ArrayList<>(list);
            list.clear();
            ...
            DiffUtil.DiffResult diff = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                @Override public boolean areItemsTheSame(int o, int n) {
                    return oldList.get(o).getId() == list.get(n).getId();
                }
                @Override public boolean areContentsTheSame(int o, int n) {
                    return oldList.get(o).getId() == list.get(n).getId()
                            && oldList.get(o).getQuantity() == list.get(n).getQuantity();
                }
            });
        ...
        public void onBindViewHolder(VH h, int pos) {
            ...
            h.qty.setText(getString(R.string.qty_prefix, item.getQuantity()));
