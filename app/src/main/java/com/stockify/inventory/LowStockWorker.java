...
public class LowStockWorker extends Worker {
    ...
    public Result doWork() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(ctx, CHANNEL_ID)
                ...
                .setContentTitle(ctx.getString(R.string.notif_low_stock_title, lowItems.size()))
                .setContentText(names.toString())
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        ctx.getString(R.string.notif_low_stock_body, lowItems.size(), names)))
                .setPriority(NotificationCompat.PRIORITY_HIGH)
                .setContentIntent(mainPi)
                .addAction(R.drawable.ic_inventory, ctx.getString(R.string.notif_action_view_low_stock), stockPi)
                .setAutoCancel(true);
