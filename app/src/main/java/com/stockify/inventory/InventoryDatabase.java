...
@Database(entities = {InventoryItem.class, StockLog.class, ValueSnapshot.class}, version = 5, exportSchema = true)
public abstract class InventoryDatabase extends RoomDatabase {
    ...
    static final Migration MIGRATION_4_5 = new Migration(4, 5) {
        @Override
        public void migrate(SupportSQLiteDatabase db) {
            db.execSQL("ALTER TABLE inventory_table ADD COLUMN costPrice REAL NOT NULL DEFAULT 0");
            db.execSQL("ALTER TABLE inventory_table ADD COLUMN reorderQuantity INTEGER NOT NULL DEFAULT 0");
        }
    };
