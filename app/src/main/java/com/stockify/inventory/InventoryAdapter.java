...
public class InventoryAdapter extends RecyclerView.Adapter<InventoryAdapter.InventoryViewHolder> {
    ...
    public void onBindViewHolder(@NonNull InventoryViewHolder holder, int position) {
        ...
        holder.quantity.setText(context.getString(R.string.qty_prefix, item.getQuantity()));
    ...
    private String buildMeta(InventoryItem item) {
        ...
        return parts.isEmpty() ? context.getString(R.string.meta_no_sku_supplier) : join(parts);
    }
